...
use bevy_mod_spritesheet::{format::json::hash::JsonHash, Frame, SpriteSheet, SpriteSheetBundle, SpriteSheetOptions, SpriteSheetPlugin};
...
fn load_sprite_sheet(asset_server: Res<AssetServer>, mut commands: Commands) {
    let sprite_sheet: Handle<SpriteSheet<JsonHash>> = asset_server.load("gabe-idle-run-hash.json");
